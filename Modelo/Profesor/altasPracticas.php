...
<body>
    <?php include '../../Controlador/Profesor/alta_practica.php'; ?>
    <div class="caja">
        <form action="../../Controlador/Profesor/alta_practica.php" method="post">
            ...
            <h3><a class="btn" href="./listarPracticas.php">Volver</a></h3>
        </form>
    </div>
</body>
</html>
